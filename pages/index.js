...
export default function Home({data}) {
	...
	<>
    	...
    	<meta name="description" content="Random Photo Generator from Unsplash" />
    	<meta name="viewport" content="width=device-width, initial-scale=1" />
  	  </Head>
    	<main className="">
      		<h1 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold my-8">Random Photo Generator</h1>
